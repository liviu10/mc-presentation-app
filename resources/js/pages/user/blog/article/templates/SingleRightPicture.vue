<template>
  <div>
    ...
    <!-- SINGLE RIGHT PICTURE WRITTEN ARTICLE TEMPLATE TITLE, SECTION END -->
    <!-- SINGLE RIGHT PICTURE WRITTEN ARTICLE TEMPLATE BODY, SECTION START -->
    <div class="lv-pg-articles-view-body">
      <div class="lv-pg-articles-view-body-heading-srp">
        <img src="/images/blog/article-img-320x320-1.jpg" alt="">
        <p>
  ...
  <!-- SINGLE RIGHT PICTURE WRITTEN ARTICLE TEMPLATE BODY, SECTION END -->
  </div>
</template>
...
export default {
  name: 'SingleRightPicture',
  data: function () {
    return {
      notifyCode: null,
      notifyMessage: null,
      showWrittenArticle: null
    }
  },
  computed: {
    // mapped getters
      ...
      axios
        ...
        .then(response => {
          ...
          if (response.data.results.length === 0) {
            ...
            this.showWrittenArticle = response.data.results
          }
        })
    }
  }
