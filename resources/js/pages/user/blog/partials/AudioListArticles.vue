<template>
  <div class="lv-pg-audio">
    ...
    <div v-if="displayAllAudioBlogArticles && displayAllAudioBlogArticles.length">
      <div v-if="displayAllAudioBlogArticles.blog_articles && displayAllAudioBlogArticles.blog_articles.length">
...
export default {
  ...
  computed: {
    ...
    getNotifyMessage () {
      return this.listOfAudioArticles.description
    }
  },
  created () {
