        ...
        <div class="lv-pg-admin-body">
          ...
          >
            <div slot="table-actions">
              <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#createNewUser">
            ...
            <template slot="table-row" slot-scope="props">
              ...
              <span v-else-if="props.column.field == 'actions'">
                <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#editUser" @click="editUser(props.row)">
                  <fa icon="edit" fixed-width />
                </button>
                <button class="btn btn-danger" @click="deleteUsers(props.row)">
