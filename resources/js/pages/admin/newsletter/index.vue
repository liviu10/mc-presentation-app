...
export default {
  ...
  computed: {
    ...mapGetters({
      user: 'auth/user',
      listOfCampaigns: 'newsletter_campaigns/listOfCampaigns',
      listOfCampaignsLogs: 'newsletter_campaigns/listOfCampaignsLogs'
    }),
  ...
  methods: {
    ...mapActions({
      fetchListOfCampaigns: 'newsletter_campaigns/fetchListOfCampaigns',
      fetchListOfCampaignLogs: 'newsletter_campaigns/fetchListOfCampaignLogs'
    }),
    ...
    async deleteAllCampaigns () {
      if (!this.user) {
        ...
        const url = window.location.origin
        const apiEndPoint = '/api/admin/system/newsletter/delete-all'
