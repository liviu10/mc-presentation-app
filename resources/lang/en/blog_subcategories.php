...
return [
    ...
    */
    ...
    'index' => [
        ...
        'info_0002_admin_message' => 'The list of blog subcategories was fetched successfully from the database!',
    ...
    'store' => [
        'info_0003_admin_message' => 'A new blog subcategory was created (:blogSubcategoryTitle) in the database!',
        'err_0001_admin_message'  => 'The blog subcategory (:blogSubcategoryTitle) you are trying to insert in the table [:tableName] could not be saved in the database, because it does not exist! Please contact the website administrator!',
        'err_0002_admin_message'  => 'The blog subcategory (:blogSubcategoryTitle) you are trying to insert in the table [:tableName] could not be saved in the database, because it does not contain the same number of column as what was requested in API! Please contact the website administrator!',
    ...
    'update' => [
        ...
        'err_0001_admin_message'  => 'The blog subcategory (:blogSubcategoryTitle) you are trying to modify in the table [:tableName] could not be saved in the database, because it does not exist! Please contact the website administrator!',
        'err_0002_admin_message'  => 'The blog subcategory (:blogSubcategoryTitle) you are trying to modify in the table [:tableName] could not be saved in the database, because it does not contain the same number of column as what was requested in API! Please contact the website administrator!',
    ],
    'delete' => [
        'info_0001_admin_message' => 'Currently, there are no defined blog subcategories in the database table [:tableName]!',
