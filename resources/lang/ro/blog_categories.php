...
return [
    ...
    */
    ...
    'index' => [
        ...
        'info_0002_admin_message' => 'Lista categoriilor blog-ului a fost adusă cu succes din baza de date!',
    ...
    'store' => [
        ...
        'err_0001_admin_message'  => 'Categoria blog-ului (:blogCategoryTitle) pe care dorești să o inserezi în tabelul [:tableName] nu a putut fi salvată în baza de date, deoarece acesta nu există! Te rog contactează administratorul website-ului!',
        'err_0002_admin_message'  => 'Categoria blog-ului (:blogCategoryTitle) pe care dorești să o inserezi în tabelul [:tableName] nu a putut fi salvată în baza de date, deoarece acesta nu conține același număr de coloane cât a fost solicitat în API! Te rog contactează administratorul website-ului!',
    ...
    'update' => [
        ...
        'err_0001_admin_message'  => 'Categoria blog-ului (:blogCategoryTitle) pe care dorești să o modifici în tabelul [:tableName] nu a putut fi salvată în baza de date! Te rog contactează administratorul website-ului!',
        'err_0002_admin_message'  => 'Categoria blog-ului (:blogCategoryTitle) pe care dorești să o modifici în tabelul [:tableName] nu a putut fi salvată în baza de date, deoarece acesta nu conține același număr de coloane cât a fost solicitat în API! Te rog contactează administratorul website-ului!',
    ],
    'delete' => [
        'info_0001_admin_message' => 'Momentan, nu există nicio categorie de blog definită în tabelul [:tableName] din baza de date!',
