    ...
    public function run()
    {
        ...
        $records = [
            [
                ...
                'notify_reference'         => config('app.url') . '/admin/documentation/warning#WAR_00001',
            ...
            [
                ...
                'notify_reference'         => config('app.url') . '/admin/documentation/information#INFO_00001',
                'created_at'               => '2021-09-26 00:00:00',
                'updated_at'               => '2021-09-26 00:00:00',
            ],
            [
                ...
                'notify_reference'         => config('app.url') . '/admin/documentation/information#INFO_00002',
                'created_at'               => '2021-09-26 00:00:00',
                'updated_at'               => '2021-09-26 00:00:00',
            ],
            [
                ...
                'notify_reference'         => config('app.url') . '/admin/documentation/information#INFO_00006',
                'created_at'               => '2021-09-26 00:00:00',
                'updated_at'               => '2021-09-26 00:00:00',
            ],
            [
                ...
                'notify_reference'         => config('app.url') . '/admin/documentation/warning#WAR_00003',
                'created_at'               => '2021-09-26 00:00:00',
                'updated_at'               => '2021-09-26 00:00:00',
            ],
            [
                ...
                'notify_reference'         => config('app.url') . '/admin/documentation/information#INFO_00003',
                'created_at'               => '2021-09-26 00:00:00',
                'updated_at'               => '2021-09-26 00:00:00',
            ],
            [
                ...
                'notify_reference'         => config('app.url') . '/admin/documentation/information#INFO_00004',
                'created_at'               => '2021-09-26 00:00:00',
                'updated_at'               => '2021-09-26 00:00:00',
            ],
            [
                ...
                'notify_reference'         => config('app.url') . '/admin/documentation/information#INFO_00005',
                'created_at'               => '2021-09-26 00:00:00',
                'updated_at'               => '2021-09-26 00:00:00',
            ],
            [
                'id'                       => '9',
                'notify_code'              => 'WAR_00004',
                'notify_short_description' => 'You do not have sufficient rights to view this resource(s)',
                'notify_reference'         => config('app.url') . '/admin/documentation/warning#WAR_00004',
                'created_at'               => '2021-09-26 00:00:00',
                'updated_at'               => '2021-09-26 00:00:00',
            ],
            [
                ...
                'notify_reference'         => config('app.url') . '/admin/documentation/error#ERR_00001',
                'created_at'               => '2021-09-26 00:00:00',
                'updated_at'               => '2021-09-26 00:00:00',
            ],
            [
                ...
                'notify_reference'         => config('app.url') . '/admin/documentation/error#ERR_00002',
                'created_at'               => '2021-09-26 00:00:00',
                'updated_at'               => '2021-09-26 00:00:00',
            ],
            [
                ...
                'notify_reference'         => config('app.url') . '/admin/documentation/error#ERR_00003',
                'created_at'               => '2021-09-26 00:00:00',
                'updated_at'               => '2021-09-26 00:00:00',
            ],
            [
                ...
                'notify_reference'         => config('app.url') . '/admin/documentation/error#ERR_00004',
                'created_at'               => '2021-09-26 00:00:00',
                'updated_at'               => '2021-09-26 00:00:00',
            ],
        ];
