...
class PageSectionController extends Controller
{
    ...
    protected $modelNamePageContactSection;
    protected $tableNamePageContactSection;
    ...
    public function __construct()
    {
        ...
        $this->modelNamePageContactSection     = new PageSectionContact();
        ...
        $this->tableNamePageContactSection     = $this->modelNamePageContactSection->getTable();
            ...
            if ($mysqlError->getCode() === '42S02')
            {
                return response([
                    ...
                    'description'        => __('error_and_notification_system.index.err_00001_notify.user_has_rights.message_super_admin', [
                        ...
                        'serviceName' => __NAMESPACE__ . '\\' . basename(PageSectionController::class) . '.php',
                        'databaseName'   => config('database.connections.mysql.database'),
                        'tableName'      => 'page_section_carousel',
                    ]),
            ...
            if ($mysqlError->getCode() === '42S02')
            {
                return response([
                    ...
                    'description'        => __('error_and_notification_system.index.err_00001_notify.user_has_rights.message_super_admin', [
                        ...
                        'serviceName' => __NAMESPACE__ . '\\' . basename(PageSectionController::class) . '.php',
                        'databaseName'   => config('database.connections.mysql.database'),
                        'tableName'      => 'page_section_jumbotron',
                    ]),
                    'reference'          => config('app.url') . '/documentation/error#ERR_00001',
                    'api_endpoint'       => $_SERVER['REQUEST_URI'],
                    'http_response'      => [
            ...
            if ($mysqlError->getCode() === '42S02')
            {
                return response([
                    ...
                    'description'        => __('error_and_notification_system.index.err_00001_notify.user_has_rights.message_super_admin', [
                        ...
                        'serviceName' => __NAMESPACE__ . '\\' . basename(PageSectionController::class) . '.php',
                        'databaseName'   => config('database.connections.mysql.database'),
                        'tableName'      => 'page_section_testimonials',
                    ]),
                    'reference'          => config('app.url') . '/documentation/error#ERR_00001',
                    'api_endpoint'       => $_SERVER['REQUEST_URI'],
                    'http_response'      => [
     ...
     * @return \Illuminate\Http\Response
     */
    public function displayContactSection()
    {
        try
        {
            $apiDisplayAllRecords = $this->modelNamePageSection->select('id', 'section_name', 'section_slug')
                                    ->with([
                                        'page_section_contact' => function ($query) {
                                            $query->select(
                                                'id',
                                                'page_section_id',
                                                'title',
            ...
            if ($apiDisplayAllRecords->isEmpty())
            {
                return response([
                    ...
                    'description'        => __('error_and_notification_system.index.war_00001_notify.user_has_rights.message_super_admin', [
                        ...
                        'serviceName' => __NAMESPACE__ . '\\' . basename(PageSectionController::class) . '.php',
                        'databaseName'   => config('database.connections.mysql.database'),
                        'tableName'      => $this->tableNamePageContactSection
                    ]),
                    'reference'          => config('app.url') . '/documentation/warning#WAR_00001',
                    'api_endpoint'       => $_SERVER['REQUEST_URI'],
                    'http_response'      => [
            ...
            if ($mysqlError->getCode() === '42S02')
            {
                return response([
                    ...
                    'description'        => __('error_and_notification_system.index.err_00001_notify.user_has_rights.message_super_admin', [
                        ...
                        'serviceName' => __NAMESPACE__ . '\\' . basename(PageSectionController::class) . '.php',
                        'databaseName'   => config('database.connections.mysql.database'),
                        'tableName'      => 'page_section_contact',
                    ]),
                    'reference'          => config('app.url') . '/documentation/error#ERR_00001',
                    'api_endpoint'       => $_SERVER['REQUEST_URI'],
                    'http_response'      => [
    ...
    public function updateContactSection(Request $request, $id)
    {
        try
        {
            ...
            $apiUpdateSingleRecord = $this->modelNamePageContactSection->find($id);
            $apiUpdateSingleRecord->update([
                'page_section_id' => 6,
                'title'           => $request->get('title'),
                'paragraph_1'     => $request->get('paragraph_1'),
                'paragraph_2'     => $request->get('paragraph_2'),
                'paragraph_3'     => $request->get('paragraph_3'),
                'paragraph_4'     => $request->get('paragraph_4'),
                'image_url'       => $request->get('image_url'),
            ]);
            $this->modelNamePageContactSection->find($apiUpdateSingleRecord->id)->log()->create([
                'status'             => 'Update',
                'status_description' => Auth::user()->name . ' has just updated the user contact section. To view this please go to user contact me page.',
                'request_details'    => __('error_and_notification_system.store.info_00002_notify.user_has_rights.message_super_admin', [
                    'record'         => $apiUpdateSingleRecord->id,
                    'databaseName'   => config('database.connections.mysql.database'),
                    'tableName'      => $this->tableNamePageContactSection,
