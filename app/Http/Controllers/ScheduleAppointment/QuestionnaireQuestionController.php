...
{
    protected $modelNameQuestionnaireQuestion;
    protected $tableNameQuestionnaireQuestion;
    protected $tableAllColumnsQuestionnaireQuestion;
    ...
    {
        $this->modelNameQuestionnaireQuestion       = new QuestionnaireQuestion();
        $this->tableNameQuestionnaireQuestion       = $this->modelNameQuestionnaireQuestion->getTable();
        $this->tableAllColumnsQuestionnaireQuestion = Schema::getColumnListing($this->tableNameQuestionnaireQuestion);
    ...
    public function index()
    {
        try 
        {
            $apiDisplayAllRecords = $this->modelNameQuestionnaireQuestion->all();
            if ($apiDisplayAllRecords->isEmpty()) 
            {
                return response([
                    ...
                    'admin_message'            => __('questionnaire.index.info_0001_admin_message', [ 'tableName' => $this->tableNameQuestionnaireQuestion ]),
                ], 404);
            }
            else 
            {
        ...
        catch (\Illuminate\Database\QueryException $mysqlError)
        {
            if ($mysqlError->getCode() === '42S02') 
            {
                return response([
                    ...
                    'admin_message'            => __('questionnaire.index.err_0001_admin_message', [ 'tableName' => $this->tableNameQuestionnaireQuestion ]),
                ], 500);
            }
        }
    }
    ...
    public function store(Request $request)
    {
        try 
        {
            ...
            {
                $apiInsertSingleRecord = $this->modelNameQuestionnaireQuestion->create([
    ...
    public function show($id)
    {
        ...
        {
            $apiDisplayAllRecords = $this->modelNameQuestionnaireQuestion->all();
            $apiDisplaySingleRecord = $this->modelNameQuestionnaireQuestion->find($id);
            if ($apiDisplayAllRecords->isEmpty()) 
            {
                return response([
                    'notify_code'              => 'INFO_0001',
                    'notify_short_description' => $this->modelNameErrorSystem::where($this->tableAllColumnsErrorSystem[1], '=', 'INFO_0001')->pluck($this->tableAllColumnsErrorSystem[2])[0],
                    'notify_reference'         => $this->modelNameErrorSystem::where($this->tableAllColumnsErrorSystem[1], '=', 'INFO_0001')->pluck($this->tableAllColumnsErrorSystem[3])[0],
                    'admin_message'            => __('questionnaire.show.info_0001_admin_message', [ 'tableName' => $this->tableNameQuestionnaireQuestion ]),
                ], 404);
            }
        ...
        catch (\Illuminate\Database\QueryException $mysqlError)
        {
            if ($mysqlError->getCode() === '42S02') 
            {
                return response([
                    ...
                    'notify_short_description' => $this->modelNameErrorSystem::where($this->tableAllColumnsErrorSystem[1], '=', 'ERR_0001')->pluck($this->tableAllColumnsErrorSystem[2])[0],
                    'notify_reference'         => $this->modelNameErrorSystem::where($this->tableAllColumnsErrorSystem[1], '=', 'ERR_0001')->pluck($this->tableAllColumnsErrorSystem[3])[0],
                    'admin_message'            => __('questionnaire.show.err_0001_admin_message', [ 'tableName' => $this->tableNameQuestionnaireQuestion ]),
                ], 500);
            }
        }
    }
    ...
    public function update(Request $request, $id)
    {
        try 
        {
            $apiUpdateSingleRecord = $this->modelNameQuestionnaireQuestion->find($id);
        ...
        catch (\Illuminate\Database\QueryException $mysqlError) 
        {
            if ($mysqlError->getCode() === '42S02')
            {
                return response([
                    ...
                    'notify_short_description' => $this->modelNameErrorSystem::where($this->tableAllColumnsErrorSystem[1], '=', 'ERR_0001')->pluck($this->tableAllColumnsErrorSystem[2])[0],
                    'notify_reference'         => $this->modelNameErrorSystem::where($this->tableAllColumnsErrorSystem[1], '=', 'ERR_0001')->pluck($this->tableAllColumnsErrorSystem[3])[0],
                    'admin_message'            => __('questionnaire.update.err_0001_admin_message', [ 'tableName' => $this->tableNameQuestionnaireQuestion, ]),
                ], 500);
            }
            if ($mysqlError->getCode() === '42S22') 
            {
                return response([
                    ...
                    'notify_short_description' => $this->modelNameErrorSystem::where($this->tableAllColumnsErrorSystem[1], '=', 'ERR_0002')->pluck($this->tableAllColumnsErrorSystem[2])[0],
                    'notify_reference'         => $this->modelNameErrorSystem::where($this->tableAllColumnsErrorSystem[1], '=', 'ERR_0002')->pluck($this->tableAllColumnsErrorSystem[3])[0],
                    'admin_message'            => __('questionnaire.update.err_0002_admin_message', [ 'tableName' => $this->tableNameQuestionnaireQuestion, ]),
                ], 500);
            }
        }
    }
        ...
        try 
        {
            ...
            if ($apiDisplayAllRecords->isEmpty()) 
            {
                return response([
                    ...
                    'notify_short_description' => $this->modelNameErrorSystem::where($this->tableAllColumnsErrorSystem[1], '=', 'INFO_0001')->pluck($this->tableAllColumnsErrorSystem[2])[0],
                    'notify_reference'         => $this->modelNameErrorSystem::where($this->tableAllColumnsErrorSystem[1], '=', 'INFO_0001')->pluck($this->tableAllColumnsErrorSystem[3])[0],
                    'admin_message'            => __('questionnaire.delete.info_0001_admin_message', [ 'tableName' => $this->tableNameQuestionnaireQuestion ]),
                ], 404);
            }
            elseif (is_null($apiDisplaySingleRecord)) 
            {
            ...
            {
                $apiDeleteSingleRecord = $this->modelNameQuestionnaireQuestion->find($id)->delete();
                return response([
        ...
        try 
        {
            ...
            if ($apiDisplayAllRecords->isEmpty()) 
            {
                return response([
                    ...
                    'notify_short_description' => $this->modelNameErrorSystem::where($this->tableAllColumnsErrorSystem[1], '=', 'INFO_0001')->pluck($this->tableAllColumnsErrorSystem[2])[0],
                    'notify_reference'         => $this->modelNameErrorSystem::where($this->tableAllColumnsErrorSystem[1], '=', 'INFO_0001')->pluck($this->tableAllColumnsErrorSystem[3])[0],
                    'admin_message'            => __('questionnaire.delete_all_records.info_0001_admin_message', [ 'tableName' => $this->tableNameQuestionnaireQuestion ]),
                ], 404);
            }
            ...
            else 
            {
                ...
                $apiDeleteSingleRecord = $this->modelNameQuestionnaireQuestion->truncate();
