...
class PageSectionJumbotron extends Model
{
    use HasFactory;
     ...
     * @var string
     */
    protected $table = 'page_section_jumbotron';
    ...
    /**
     * Eloquent polymorphic relationship between page_section_jumbotron and logs.
     *
     */
    public function log()
    {
